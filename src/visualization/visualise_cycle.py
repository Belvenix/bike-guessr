...
def _show_preds(grapf_networkx: MultiDiGraph, mask: Tensor, preds: Tensor, name: str, popup: bool):
    ...
    m.save(f"./visu/{name}_{popup!s}_predictions.html")
...
if __name__ == "__main__":
    ...
    ox_graph_name = "Wałbrzych_Poland_recent.xml"
    dgl_graph_name = "Walbrzych.bin"
    prediction_file = "Wałbrzych_Poland_recent.pkl"
